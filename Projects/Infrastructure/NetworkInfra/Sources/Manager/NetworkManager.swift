...
public final class NetworkManager {
    ...
    let openF1SessionProvider: OpenF1SessionNetworkType
    ...
    public init(
        ...
        if withTest {
            ...
            self.openF1SessionProvider = .stubbingNetworking(baseURL: openF1BaseURL, needFail: withFail)
        } else {
            ...
            self.openF1SessionProvider = .defaultNetworking(baseURL: openF1BaseURL)
        }
    }
}
